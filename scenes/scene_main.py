...
class Scene_Main(Scene):
    def instantiate_objects(self):
        ...
        # lightObj = GameObject("light")
        # light = lightObj.add_component(PointLight)
        # lightObj.add_component(CameraController)
        # lightObj.transform.position = vector3(0,0,5)
        # light_renderer = lightObj.add_component(MeshRenderer)
        # light_renderer.mesh = Mesh.create_cube((.4, .4, .4))
        # light_renderer.material = Material(color(1,1,1,1), "TestMaterial1")
